...
CreateVertexStructWrapper[expr_] := expr /. {SARAH`Cp[fields__]/;!FreeQ[{fields},Except[List[__], _[__]]]->VERTEXSTRUCT[SARAH`Cp[fields]],
                                     SARAH`Cp[fields__][lorentz_]/;!FreeQ[{fields},Except[List[__], _[__]]]->VERTEXSTRUCT[SARAH`Cp[fields][lorentz]]}
